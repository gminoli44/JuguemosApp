...
public class Numerosuerte extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_numerosuerte);
        WebView myWebView = (WebView) findViewById(R.id.web_suerte);
        ...
        myWebView.loadUrl("http://juguemos.com.co/app_numerosuerte.php");
